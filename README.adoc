...
giteaExtraVolumes:
  description: 'Extra volumes to attach to the Gitea container'
  type: array
  items:
    type: object
    properties:
      name:
        description: Name of the volume item
        type: string
      type:
        description: Type of volume - secret | configMap
        type: string
      targetName:
        description: Name of the target volume to mount
        type: string
      mountPath:
      ...
      readOnly:
        ...
        type: boolean
      mountItems:
        description: List of items from the Secret or ConfigMap to mount
        type: array
        items:
          type: object
          properties:
            key:
              description: Data item key name
              type: string
            path:
              description: Mount path of the item
              type: string
